...
let sphereData = {color: "red"};
let sphere = new ThreeObjects.buildSphere(-5,2,-5, "#ffffff");
scene.add(sphere);

function sphereBounce(){
gsap.set(sphere.position, {y:10});
gsap.to(sphere.position, 2, {y:1, ease:"bounce"});
}

window.addEventListener('click', sphereBounce)
